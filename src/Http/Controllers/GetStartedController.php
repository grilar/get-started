...
namespace Grilar\GetStarted\Http\Controllers;
...
use Grilar\GetStarted\Http\Requests\GetStartedRequest;
    ...
    public function save(GetStartedRequest $request, BaseHttpResponse $response): BaseHttpResponse
    {
        ...
        switch ($step) {
            ...
            case 2:
                ...
                if ($user->username != config('core.base.general.demo.account.username', 'grilar') &&
